...
void D_Patch (void)
{
	...
	if (!protectset8)
	{
		Sys_MakeCodeWriteable ((void*)D_PolysetAff8Start,
						     (size_t)D_Aff8Patch - (size_t)D_PolysetAff8Start);
		Sys_MakeCodeWriteable ((void*)R_Surf8Start,
						 (size_t)R_Surf8End - (size_t)R_Surf8Start);
		protectset8 = true;
	}
