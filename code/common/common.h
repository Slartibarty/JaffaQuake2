...
#ifndef NULL
#error You have bigger problems than this
#endif
...
// Double M_PI
#define M_PID		3.14159265358979323846	// matches value in gcc v2 math.h
...
inline int Q_strcasecmp (const char *str1, const char *str2)
{
#ifdef _WIN32
...
inline int Q_strncasecmp (const char *str1, const char *str2, int n)
{
#ifdef _WIN32
...
inline char *Q_strdup (const char *str)
{
#ifdef _WIN32
	return _strdup (str);
#else
...
inline int Q_putenv (const char *str)
{
#ifdef _WIN32
	return _putenv (str);
#else
...
#else
#define Com_sprintf sprintf_s
#endif

void* Com_StackAlloc(size_t size);
