...
//
// Defines stuff for the connection between the engine and the refesh, therefore
// common is the best place for this
//
...
typedef struct
{
	void	(*Sys_Error) (int err_level, const char *msg);
	void	(*Sys_Errorf) (int err_level, const char *fmt, ...);
