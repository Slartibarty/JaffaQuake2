...
void CL_Record_f (void)
{
	...
	FS_OpenFileWrite(name, &cls.demofile, fs_overwrite);
	if (!cls.demofile)
	{
...
void CL_ConnectionlessPacket (void)
{
	...
	if (!strcmp(c, "cmd"))
	{
		...
		{
			Com_Print ("Command packet from remote host.  Ignored.\n");
			return;
		}
		Sys_AppActivate ();
		s = MSG_ReadString (&net_message);
...
void CL_WriteConfiguration (void)
{
	...
	FS_Write("// generated by quake, do not modify\n", -1, f);
