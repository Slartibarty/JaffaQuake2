...
static void CDAudio_Eject(void)
{
    ...
    if ((dwReturn = mciSendCommandA(wDeviceID, MCI_SET, MCI_SET_DOOR_OPEN, (DWORD_PTR) NULL)))
...
static void CDAudio_CloseDoor(void)
{
    ...
    if ((dwReturn = mciSendCommandA(wDeviceID, MCI_SET, MCI_SET_DOOR_CLOSED, (DWORD_PTR) NULL)))
...
static int CDAudio_GetAudioDiskInfo(void)
{
    ...
    dwReturn = mciSendCommandA(wDeviceID, MCI_STATUS, MCI_STATUS_ITEM | MCI_WAIT, (DWORD_PTR) &mciStatusParms);
	if (dwReturn)
	{
...
void CDAudio_Play2(int track, qboolean looping)
{
    ...
    dwReturn = mciSendCommandA(wDeviceID, MCI_STATUS, MCI_STATUS_ITEM | MCI_TRACK | MCI_WAIT, (DWORD_PTR) &mciStatusParms);
	if (dwReturn)
	{
    ...
    dwReturn = mciSendCommandA(wDeviceID, MCI_PLAY, MCI_NOTIFY | MCI_FROM | MCI_TO, (DWORD_PTR) &mciPlayParms);
	if (dwReturn)
	{
...
void CDAudio_Stop(void)
{
    ...
    if ((dwReturn = mciSendCommandA(wDeviceID, MCI_STOP, 0, (DWORD_PTR) NULL)))
...
void CDAudio_Pause(void)
{
    ...
    if ((dwReturn = mciSendCommandA(wDeviceID, MCI_PAUSE, 0, (DWORD_PTR) &mciGenericParms)))
...
void CDAudio_Resume(void)
{
    ...
    mciPlayParms.dwCallback = (DWORD_PTR)cl_hwnd;
    dwReturn = mciSendCommandA(wDeviceID, MCI_PLAY, MCI_TO | MCI_NOTIFY, (DWORD_PTR) &mciPlayParms);
	if (dwReturn)
	{
		Com_DPrintf("CDAudio: MCI_PLAY failed (%i)\n", dwReturn);
		return;
...
int CDAudio_Init(void)
{
	...
	if ((dwReturn = mciSendCommandA(0, MCI_OPEN, MCI_OPEN_TYPE | MCI_OPEN_SHAREABLE, (DWORD_PTR) &mciOpenParms)))
	{
    ...
    if ((dwReturn = mciSendCommandA(wDeviceID, MCI_SET, MCI_SET_TIME_FORMAT, (DWORD_PTR) &mciSetParms)))
    {
...
//		Com_Printf("CDAudio_Init: No CD in player.\n");
	...
	Com_Print("CD Audio Initialized\n");
