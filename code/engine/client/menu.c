...
{
	s_multiplayer_menu.x = viddef.width * 0.5f - 64;
...
static void Keys_MenuInit( void )
{
	...
	s_keys_menu.x = viddef.width * 0.5f;
...
void Game_MenuInit( void )
{
	...
	s_game_menu.x = viddef.width * 0.5f;
...
void JoinServer_MenuInit( void )
{
	...
	s_joinserver_menu.x = viddef.width * 0.5f - 120;
...
//=======
	...
	*/
	s_startserver_menu.x = viddef.width * 0.5f;
...
const char *StartServer_MenuKey( int key )
{
	if ( key == K_ESCAPE )
	{
		if ( mapnames )
		{
			// Slart: nummaps + 1 is allocated
			// This led to a memory leak that I just fixed
...
void DMOptions_MenuInit( void )
{
	...
	s_dmoptions_menu.x = viddef.width * 0.5f;
...
void DownloadOptions_MenuInit( void )
{
	...
	s_downloadoptions_menu.x = viddef.width * 0.5f;
...
static qboolean PlayerConfig_ScanDirectories( void )
{
	...
	*/
	...
	// Slart: Is this correct? This previously would return nothing
	// Doesn't matter too much because the return value of this function is never evaluated
	return true;
}
